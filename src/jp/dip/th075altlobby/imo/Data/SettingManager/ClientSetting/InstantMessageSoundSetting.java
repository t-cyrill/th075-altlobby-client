...
/**
 * <h1>InstantMessageSoundSetting</h1> <h2>インスタントメッセージの設定をやり取りするクラス</h2>
 * <p>
 * インスタントメッセージのサウンド設定をやり取りするときに使用します。
 * </p>
 * <p>
...
public class InstantMessageSoundSetting extends Setting {
    private final Boolean wholeIMPlaySound, toMePlaySound, nonIMSoundIfPlaying,
            nonIMPlayingIfWindowFocused;

    private final String wavePath, toMeWavePath;

    public InstantMessageSoundSetting(boolean wholeIMPlaySound,
            String wavePath, boolean toMePlaySound, String toMeWavePath,
            boolean nonIMSoundIfPlaying, boolean nonIMPlayingIfWindowFocused) {
    ...
    public InstantMessageSoundSetting(String wholeIMPlaySound, String wavePath,
            String toMePlaySound, String toMeWavePath,
            String nonIMSoundIfPlaying, String nonIMPlayingIfWindowFocused) {
        ...
        this.nonIMPlayingIfWindowFocused = Boolean
                .valueOf(nonIMPlayingIfWindowFocused);
    }
