...
public class TableSetting extends Setting {
    ...
    private final Integer table_name_width, table_ip_width, table_uid_width,
            table_state_width, table_im_width, table_short_msg_width;

    public TableSetting(String table_headers_order, int table_name_width,
            int table_ip_width, int table_uid_width, int table_state_width,
            int table_im_width, int table_short_msg_width) {
    ...
    public TableSetting(String table_headers_order, String table_name_width,
            String table_ip_width, String table_uid_width,
            String table_state_width, String table_im_width,
