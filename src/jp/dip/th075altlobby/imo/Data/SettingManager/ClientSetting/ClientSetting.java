...
/**
 * <h1>ClientSetting</h1> <h2>クライアントアプリケーションの設定をやり取りするクラス</h2>
 * <p>
 * クライアントアプリケーションの設定をやり取りに使用します。
 * </p>
 * <p>
...
public class ClientSetting {
    ...
    public ClientSetting(ConnectionSetting c, InstantMessageSetting im,
            InstantMessageSoundSetting ims, CasterSetting cas, WindowSetting w,
            TableSetting t, String ng, boolean hostOnly) {
        clientSetting = c;
        imSetting = im;
        imsoundSetting = ims;
        casterSetting = cas;
    ...
    public ClientSetting() {
        clientSetting = new ConnectionSetting("名無しさん", "切断自由です", "切断自由です",
                false);
        imSetting = new InstantMessageSetting(true, "1000", 0, 0, "30");
        imsoundSetting = new InstantMessageSoundSetting(false, "", false, "",
                true, true);
        casterSetting = new CasterSetting("", 7500);
        windowSetting = new WindowSetting(278, 360, 360, 360, 10, 10, 800, 600,
                0, 0, true);
