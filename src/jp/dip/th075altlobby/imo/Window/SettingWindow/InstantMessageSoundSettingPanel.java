...
public class InstantMessageSoundSettingPanel extends JPanel {
	...
	public InstantMessageSoundSettingPanel(InstantMessageSoundSetting setting) {
		...
		IMPlaySoundCheckBox = new JCheckBox(resource.getString("config.tab.IMsound.playsound1"));
		IMPlaySoundCheckBox.setBounds( 5, 10, 220, 20);
		IMPlaySoundCheckBox.setSelected(setting.getWholeIMPlaySound());

		JLabel IMSoundLabel = new JLabel(resource.getString("config.tab.IMsound.playsound1.wav"));
		...
		toMeIMPlaySoundCheckBox = new JCheckBox(resource.getString("config.tab.IMsound.playsound2"));
		toMeIMPlaySoundCheckBox.setBounds( 5, 105, 220, 20);
		toMeIMPlaySoundCheckBox.setSelected(setting.getToMePlaySound());

		JLabel IMTomeSoundLabel = new JLabel(resource.getString("config.tab.IMsound.playsound2.wav"));
		...
		nonIMSoundPlayDuringMatchingComboBox = new JCheckBox(resource.getString("config.tab.IMsound.non_im.matching"));
		nonIMSoundPlayDuringMatchingComboBox.setBounds(5, 190, 200, 20);
		nonIMSoundPlayDuringMatchingComboBox.setSelected(setting.getNonIMSoundIfPlaying());

		nonIMSoundPlayIfWindowForcused = new JCheckBox(resource.getString("config.tab.IMsound.non_im.forcused"));
		nonIMSoundPlayIfWindowForcused.setBounds(5, 210, 200, 20);
		nonIMSoundPlayIfWindowForcused.setSelected(setting.getNonIMPlayingIfWindowFocused());
	...
	public void registerListeners() {
		...
		waveChooseButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				filechooser.addChoosableFileFilter(new FileNameExtensionFilter("WAVEファイル", "wav"));
	...
	public InstantMessageSoundSetting getSettingValues() {
		return new InstantMessageSoundSetting(
				IMPlaySoundCheckBox.isSelected(),
