...
public class CasterTerminalPanel extends JPanel {
     ...
     * <p>
     * このクラスのkeyPressedメソッドはイベントディスパッチスレッドから呼ばれます。
     * </p>
     * <p>
     * 内部で呼び出す{@link CallBackRunnable#run(String)}もイベントディスパッチスレッドで実行されます。
     * </p>
     * 
     * @author Cyrill
     * @since rev31
    ...
    /**
     * <h1>append</h1> <h2>テキストを追加する</h2>
     * <p>
     * このコントロールのテキストを追加します。 追加したテキストの最後には改行が自動的に設定されます。
     * </p>
     * <h3>スレッドセーフ</h3>
     * <p>
     * このメソッドは{@link JNaturalTextPane#append(String)}を読み出します。<br>
     * このメソッドは例外的にスレッドセーフです。SwingのEDT以外からでも安全に呼び出すことができます。 詳細は
     * {@link JTextArea#append(String)}を参照してください。
     * </p>
     * 
     * @param s
     *            追加するテキスト
