 ...
 * <p>rev 27から追加された{@link IOStreamCasterAdapter#casterOutput(String)}をオーバーライドすることで、
 * 一行ごとの出力を通知可能に拡張した{@link IOStreamCasterAdapter}です。</p>
 * <p>一行ごとの出力を拾う以外はIOStreamCasterAdapterと同等の機能を持ちます。</p>
 *
 * @since rev27
 * @author Cyrill
 *
 */
public class IOStreamCasterAdapterWithOutputCallback extends IOStreamCasterAdapter {
	private final CallBackRunnable callback;
	private final Logger logger = Logger.getLogger("jp.dip.th075altlobby");

	public IOStreamCasterAdapterWithOutputCallback(CasterEventInterface eventInterface, StateChangeListener listener,
			CallBackRunnable outputCallBack, String... command) throws IOException {
