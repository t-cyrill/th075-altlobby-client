...
public interface ClientConstants {
	...
	final String ConnectionWindowCaption = "東方萃夢想 Alt Lobby Client ("+ClientVersionString+")";
	final String SettingWindowCaption = "設定";
	final String MainWindowCaption = "東方萃夢想 Alt Lobby Client ("+ClientVersionString+")";
