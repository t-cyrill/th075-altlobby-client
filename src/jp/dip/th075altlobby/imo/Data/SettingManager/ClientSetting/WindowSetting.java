...
public class WindowSetting extends Setting {
    ...
    private final Integer horizontal_split_devider_location,
            ...
            main_win_pos_x, main_win_pos_y, main_win_width, main_win_height;
    // IM Controls
    private final Integer IM_Color, IM_Filter;
    ...
    public WindowSetting(
            ...
            int main_win_pos_x, int main_win_pos_y, int main_win_width,
            int main_win_height, int IM_Color, int IM_Filter,
    ...
    public WindowSetting(
            ...
            String main_win_pos_x, String main_win_pos_y,
            String main_win_width, String main_win_height, String IM_Color,
            String IM_Filter, String console_auto_scroll) {
        this.horizontal_split_devider_location = toInt(
                horizontal_split_devider_location, 400);
        this.left_vertical_split_devider_location = toInt(
                left_vertical_split_devider_location, 400);
        this.right_vertical_split_devider_location = toInt(
                right_vertical_split_devider_location, 200);
        this.right_vertical_split_instantMessage_to_casterTerminalPane_devider_location = toInt(
                right_vertical_split_instantMessage_to_casterTerminalPane_devider_location,
                360);
