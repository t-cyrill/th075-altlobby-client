...
/**
 * <h1>InstantMessageSetting</h1>
 * <h2>インスタントメッセージの設定をやり取りするクラス</h2>
 * <p>インスタントメッセージの設定をやり取りするときに使用します。</p>
...
public class InstantMessageSetting extends Setting {
	...
	private final Integer 	IMLogHoldLimit,
							IMState,
							IMSendKey,
							oldIMReadCounter;

	public InstantMessageSetting(
			boolean imAutoLogging,
			String IMLogHoldLimit,
			int IMState,
			int IMSendKey,
			String oldIMReadCounter) {
