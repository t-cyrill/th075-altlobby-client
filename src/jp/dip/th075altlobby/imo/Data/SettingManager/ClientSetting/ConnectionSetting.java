...
/**
 * <h1>ConnectionSetting</h1>
 * <h2>接続設定を格納するクラス</h2>
 * <p>クライアントの設定のうち接続設定を格納するクラスです。</p>
 * <p>このクラスのインスタンスは不可変です。複数のスレッドから安全に読み取ることができます。</p>
 *
 * @author Cyrill
 *
 */
public class ConnectionSetting {
	...
	public ConnectionSetting(String name, String message, String short_msg, boolean ip_hide_flag) {
		this.name = name;
