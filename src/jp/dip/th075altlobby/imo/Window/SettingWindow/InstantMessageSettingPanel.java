...
public class InstantMessageSettingPanel extends JPanel {
    ...
    public InstantMessageSettingPanel(InstantMessageSetting setting) {
        ...
        IMAutoLoggingCheckBox = new JCheckBox(
                resource.getString("config.tab.IM.autoLogging"));
        IMAutoLoggingCheckBox.setBounds(20, 20, 200, 20);
        IMAutoLoggingCheckBox.setSelected(setting.getIMAutoLogging());
        IMAutoLoggingCheckBox.setToolTipText(resource
                .getString("config.tab.IM.autoLogging.tip"));

        JLabel IMLogHoldCounterLabel = new JLabel(
                resource.getString("config.tab.IM.hold_limit"));
        ...
        IMLogHoldCounterTextField.setText(setting.getIMLogHoldLimit()
                .toString());
        IMLogHoldCounterTextField.setToolTipText(resource
                .getString("config.tab.IM.hold_limit.tip"));

        JLabel IMHistoryRequestLabel = new JLabel(
                resource.getString("config.tab.IM.history"));
        ...
        IMHistoryRequestLimitTextField.setText(setting.getOldIMReadCounter()
                .toString());
        IMHistoryRequestLabel.setToolTipText(resource
                .getString("config.tab.IM.history.tip"));

        JLabel IMStateLabel = new JLabel(
                resource.getString("config.tab.IM.IMPolicy"));
        ...
        IMAcceptPolicyComboBox.addItem(resource
                .getString("config.tab.IM.IMPolicy.item1"));
        IMAcceptPolicyComboBox.addItem(resource
                .getString("config.tab.IM.IMPolicy.item2"));
        IMAcceptPolicyComboBox.addItem(resource
                .getString("config.tab.IM.IMPolicy.item3"));
        ...
        IMSendKeyComboBox.addItem(resource
                .getString("config.tab.IM.sendkey.item1"));
        IMSendKeyComboBox.addItem(resource
                .getString("config.tab.IM.sendkey.item2"));
